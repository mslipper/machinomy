...
var ChannelContract = /** @class */ (function () {
    ...
    ChannelContract.prototype.open = function (sender, receiver, price, settlementPeriod, channelId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cId = channelId ? channelId : ChannelContract.generateId();
                        return [4 /*yield*/, this.contract()];
                    case 1:
                        deployed = _a.sent();
                        return [2 /*return*/, deployed.open(cId.toString(), receiver, settlementPeriod, {
                                from: sender,
                                value: price,
    ...
    ChannelContract.prototype.channelById = function (channelId) {
        return __awaiter(this, void 0, void 0, function () {
            var deployed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deployed = _a.sent();
                        return [2 /*return*/, deployed.channels(channelId)];
                }
            });
        });
    };
