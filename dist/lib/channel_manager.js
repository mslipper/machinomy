...
var ChannelManagerImpl = /** @class */ (function (_super) {
    ...
    ChannelManagerImpl.prototype.openChannel = function (sender, receiver, amount, minDepositAmount, channelId) {
        var _this = this;
        return this.mutex.synchronize(function () { return _this.internalOpenChannel(sender, receiver, amount, minDepositAmount, channelId); });
    };
    ...
    ChannelManagerImpl.prototype.internalOpenChannel = function (sender, receiver, amount, minDepositAmount, channelId) {
        var _this = this;
    ...
    ChannelManagerImpl.prototype.buildChannel = function (sender, receiver, price, settlementPeriod, providedChannelId) {
        return __awaiter(this, void 0, void 0, function () {
            var res, channelId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.channelContract.open(sender, receiver, price, settlementPeriod, providedChannelId)];
                    case 1:
                        res = _a.sent();
