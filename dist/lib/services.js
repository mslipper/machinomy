...
const payment_manager_1 = require("./payment_manager");
function defaultRegistry() {
    ...
    serviceRegistry.bind('PaymentManager', (chainManager, channelContract, options) => new payment_manager_1.default(chainManager, channelContract, options), ['ChainManager', 'ChannelContract', 'MachinomyOptions']);
