...
const accept_payment_request_1 = require("./lib/accept_payment_request");
/**
...
class Machinomy {
    ...
    async buy(options) {
        ...
        const res = await this.client.doPayment(payment, options.gateway, options.purchaseMeta);
     ...
     */
    acceptPayment(req) {
        return this.client.acceptPayment(accept_payment_request_1.AcceptPaymentRequestSerde.instance.deserialize(req));
    }
    /**
